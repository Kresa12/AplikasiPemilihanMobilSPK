        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Form Edit Mobil</h3>
                    ...
                    <form action="{{ route('mobils.update', $mobil->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_mobil" id="nama_mobil" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('nama_mobil', $mobil->nama_mobil) }}" required>
                        </div>

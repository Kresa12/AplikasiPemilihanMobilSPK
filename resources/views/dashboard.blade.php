            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Anda telah masuk ke dalam Sistem Pendukung Keputusan Penentuan Siswa Teladan.
                    </p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="{{ route('alternatif.index') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700/50 transition ease-in-out duration-150">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-lg font-semibold text-gray-900 dark:text-gray-100">Data Siswa</p>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Kelola data siswa & nilai.</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="{{ route('perhitungan.index') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700/50 transition ease-in-out duration-150">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Lihat hasil ranking siswa.</p>
                        </div>
                    </div>
                </a>
            </div>
